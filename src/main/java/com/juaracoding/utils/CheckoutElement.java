...
public class CheckoutElement {
    public static final String PROCEEDCHECKOUT = "//a[@class='checkout-button button alt wc-forward']";
    ...
    public static final String COMBOBOX = "//input[@role='combobox']";
    ...
    public static final String PHONE = "//input[@id='billing_phone']";
    public static final String EMAIL = "//input[@id='billing_email']";
    ...
    public static final String TXTALERT = "//ul[@class='woocommerce-error']";
